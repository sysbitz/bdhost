			...
			<div className="grid grid-cols-3 gap-4">
					...
					<div className="rounded-xl border border-border bg-card p-5">
						<div className="mb-3 flex items-center justify-between">
							<div>
								...
								<p className="text-sm text-muted-foreground">
									Choose the HTML file that opens when someone visits your app
									link.
								</p>
							</div>
						</div>
						...
						<p className="mb-3 flex items-center gap-1.5 text-xs font-medium text-emerald-600">
							<Check className="h-3.5 w-3.5" /> {app.landingFile} is linked to
							your app URL
						</p>
						<input
							ref={fileInputRef}
				...
				<div className="space-y-4">
					<div className="rounded-xl border border-border bg-card p-5">
						...
						{copied && (
							<p className="mt-1.5 text-xs text-muted-foreground">Copied!</p>
						)}
						<p className="mt-3 flex items-center gap-1.5 text-xs text-muted-foreground">
							<Shield className="h-3.5 w-3.5" /> Secure link included with your
							app
						</p>
					</div>
					...
					<div className="rounded-xl border border-border bg-card p-5">
						...
						<p className="mb-3 text-sm text-muted-foreground">
							Upload your site files, then link an HTML file as the landing
							page.
						</p>
						<button
							onClick={handleUploadClick}
